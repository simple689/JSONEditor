...
WidgetTab.prototype.addHistoryPage = function (historyItemFile) {
    ...
    for (var o in fileList) {
        ...
        var elementTabTitle = this.addTitle(value[KeyBase._fileName]);
        // this.addContent(elementTabTitle, value[KeyBase._fileContent], WidgetTab._enumAddContentType.fileContent);
        this.addContent(elementTabTitle, value[KeyBase._fileContent], WidgetTab._enumAddContentType.fileJsonObj);
    }
}
