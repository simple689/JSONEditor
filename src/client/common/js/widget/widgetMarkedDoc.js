...
WidgetMarkedDoc.prototype.create = function (elementParent, html, pageRoot, page) {
    ...
    this.init(this._divLeft, this._divMiddle, this._divRight, html);
}

WidgetMarkedDoc.prototype.init = function (left, middle, right, html) {
    ...
    this.initLeft(left, html);
    this.initRight(right);
};
WidgetMarkedDoc.prototype.initLeft = function (left, html) {
    $(left).load(html, function () {
        if (!window.Promise) {
