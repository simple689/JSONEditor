...
PanelMenu.prototype.init = function (elementParentID) {
    ...
    // 根据用户使用设备调整按钮的可见性
    switch (confDeviceType) {
        case enumConfDeviceType.appPC:
        case enumConfDeviceType.appMobile: {
...
PanelMenu.showDialogHelp = function (widgetDialog) {
    ...
    widgetMarkedDoc.create(widgetDialog._elementDialogContent, "./menu/menuHelp.html", confProjectRoot + '/doc/', '/README.md');
